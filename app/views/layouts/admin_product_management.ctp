	...
	<body>
		<div class="container">
			...
			<dl class="subnavigation">
				...
				<?php } ?>
				<dd class="search">
					<?php echo $form->create('Search', array('type' => 'post', 'url' => array('controller' => 'item', 'action' => 'search', 'prefix' => 'admin'))); ?>
						<?php echo $form->input('Search.item', array('label' => 'Search', 'value' => $searchString)); ?>
					<?php echo $form->end(); ?>
				</dd>
			</dl>
