<?php
	...
	$this->pageTitle = 'Lucca Antiques - Elle D&eacute;cor May 2009';
?>
				...
				<div class="wrapper">
					...
					<div class="nav">
						<dl>
							...
							<dd class="current-press-item"><a href="/pages/press_ed_may09/">-- Elle D&eacute;cor May (May 2009)</a></dd>
                            <dd><a href="/pages/press_hb_aug08/">-- House Beautiful (August 2008)</a></dd>
						</dl>
					</div>
					<div class="details">
						<h3>Elle Décor (May 2009)</h3>
						<p>Chairs, Lucca Antiques</p>
						<p class="tabs">
						...
						<?php $settings = array('w'=>527, 'crop'=>1); ?>
          				...
          				<!--Start Tabcontent 1 -->
						<div id="tabcontent1">
						<a class="image" href="/press/images/ed_may09/1_ed_may09.jpg">
						<img src="<?=$resizeimage->resize(WWW_ROOT . '/press/images/ed_may09/1_ed_may09.jpg', $settings)?>" border="0" />
						</a>
						</div>
						<!--End Tabcontent 1-->
						...
						<!--Start Tabcontent 2-->
						<div id="tabcontent2">
						<a class="image" href="/press/images/ed_may09/2_ed_may09.jpg">
						<img src="<?=$resizeimage->resize(WWW_ROOT . '/press/images/ed_may09/2_ed_may09.jpg', $settings)?>" border="0" />
						</a>
						</div>
						<!--End Tabcontent 2 -->
						...
						<!--Start Tabcontent 3-->
						<div id="tabcontent3">
						<a class="image" href=""><img src="/press/images/hb_aug09/#.jpg" alt="" /></a>
						</div>
						<!--End Tabcontent 3-->
