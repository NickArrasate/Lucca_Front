				...
				<div class="wrapper">
					...
					<div class="nav">
						<dl>
                            ...
                            <dd class="current-press-item"><a href="/pages/press_hb_aug08/">-- House Beautiful (August 2008)</a></dd>
						</dl>
					</div>
					<div class="details">
						<h3>House Beautiful (August 2008)</h3>
						...
						<p class="tabs">
							...
							<span style="display:none;" onclick="easytabs('1', '2');" onfocus="easytabs('1', '2');" id="tablink2"><a onclick="return false;" href="#" title="">2</a></span>
						...
						<?php $settings = array('w'=>527, 'crop'=>1); ?>
          				...
          				<!--Start Tabcontent 1 -->
						<div id="tabcontent1">
						<a class="image" href="/press/images/hb_aug08/1_hb_aug08.jpg">
						<img src="<?=$resizeimage->resize(WWW_ROOT . '/press/images/hb_aug08/1_hb_aug08.jpg', $settings)?>" border="0" />
						</a>
						</div>
						<!--End Tabcontent 1-->
						...
						<!--Start Tabcontent 2-->
						<div id="tabcontent2">
						<a class="image" href=""><img src="/press/images/hb_aug08/#.jpg" alt="" /></a>
						</div>
						<!--End Tabcontent 2 -->
