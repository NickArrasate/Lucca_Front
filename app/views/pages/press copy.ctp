...
<div class="footerpage press">
			<div class="overlay">
				<div class="wrapper">
					...
					<div class="nav">
						<dl>
							<dd class="current-press-item"><a href="/pages/press/">-- Santa Barbara (2010)</a></dd>
					...
					<div class="details">
						<h3>Santa Barbara Magazine (Design Issue 2010)</h3>
						<p class="tabs">
						...
						<?php $settings = array('w'=>527, 'crop'=>1); ?>
          				<!--Start Tabcontent 1 -->
						<div id="tabcontent1">
						<a class="image" href="/press/images/sb_10/1_sb_10.jpg">
						<img src="<?=$resizeimage->resize(WWW_ROOT . '/press/images/sb_10/1_sb_10.jpg', $settings)?>" border="0" />
