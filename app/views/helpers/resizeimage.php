...
class ResizeimageHelper extends Helper {
	...
	*/
	...
	function resize($imagePath,$opts=null){
		...
		$cacheFolder = WWW_ROOT . '/cache/'; # path to your cache folder, must be writeable by web server
		...
		return str_replace(WWW_ROOT,'',$newPath);
