        ...
        <div class="wrapper col-xs-12">
            <div class="row" id="trade">
                <div class="col-sm-6">
                    ...
                    <p style="font-family: vinchandregular; font-size:30px">To request a Lucca Studio piece in a custom size, simply follow the instructions to the right.</p>
                    <p style="font-family: vinchandregular; font-size:30px">Please remember...</p>
                    <ul>
                ...
                <div class="col-sm-6">
                        <div style="border-left:1px solid #ccc;padding:0px 50px;margin-top:60px" >
                          <p style="font-family: vinchandregular; font-size:30px">Request a custom piece</p>
